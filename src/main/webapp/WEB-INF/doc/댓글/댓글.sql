...
CREATE TABLE reply(
        ...
        content_no                           NUMBER(10)    NOT     NULL ,
        memberno                            NUMBER(10)         NOT NULL ,
        reply_content                               VARCHAR2(1000)         NOT NULL,
        passwd                                VARCHAR2(20)         NOT NULL,
        reply_crtime                              DATE      NOT NULL,
...
COMMENT ON COLUMN reply.content_no is '컨텐츠번호';
...
COMMENT ON COLUMN reply.reply_crtime is '등록일';
...
VALUES(reply_seq.nextval, 6, 4, '댓글1', '1234', sysdate);
INSERT INTO reply(replyno, content_no, memberno, reply_content, passwd, reply_crtime)
VALUES(reply_seq.nextval, 6, 4, '댓글2', '1234', sysdate);
INSERT INTO reply(replyno, content_no, memberno, reply_content, passwd, reply_crtime)
VALUES(reply_seq.nextval, 6, 4, '댓글3', '1234', sysdate);             
...
SELECT m.id,
           r.replyno, r.content_no, r.memberno, r.reply_content, r.passwd, r.reply_crtime
FROM member m,  reply r
WHERE (m.memberno = r.memberno) AND r.content_no=6
ORDER BY r.replyno DESC;
...
6) content_no에 해당하는 댓글 수 확인 및 삭제
SELECT COUNT(*) as cnt
FROM reply
WHERE content_no=6;
