    ...
    <table class="table table-striped" style='width: 100%;'>
      ...
      <tbody>
        <c:forEach var="replyVO" items="${list }">
          <c:set var="content_no" value="${replyVO.content_no }" />
          ...
          <tr style='height: 50px;'> 
            ...
            <td style='text-align: center; vertical-align: middle;'>
              <A href='../brcontent/read.do?content_no=${content_no }'>${conten_no}</A>
            </td>
            <td style='text-align: center; vertical-align: middle;'>
              <A href='../member/read.do?memberno=${replyVO.memberno }'>${replyVO.memberno}</A>
            </td>
            <td style='text-align: left; vertical-align: middle;'>${replyVO.reply_content}</td>
            <td style='text-align: center; vertical-align: middle;'>
              ${replyVO.reply_crtime.substring(0, 10)}
            </td>
            <td style='text-align: center; vertical-align: middle;'>
