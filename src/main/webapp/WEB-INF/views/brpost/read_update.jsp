...
<DIV class='title_line'>빵 추천 게시판 > ${post_name } 조회(수정)</DIV>
...
<DIV class='content_body'>
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_update' id='frm_update' method='POST' action='./update.do'>
      ...
      <input type='text' name='post_name' value="${post_name }" required="required" 
                 autofocus="autofocus" style='width: 25%;'>
 
       <label>생성자ID</label>
      <input type='text' name='post_id' value="${post_id }" required="required" 
                 autofocus="autofocus" style='width: 25%;'>
